...
def insert_04():
    ...
    conn = conectar()
    cursor = conn.cursor()
    cursor.execute("INSERT INTO estudiantes (nombre, apellido, email, fecha_nacimiento) VALUES (?, ?, ?, ?)", ("Valentina", "Ruiz", "valentina.ruiz@email.com", "2003-05-15"))
    cursor.execute("INSERT INTO estudiantes (nombre, apellido, email, fecha_nacimiento) VALUES (?, ?, ?, ?)", ("Mateo", "Torres", "mateo.torres@email.com", "2004-09-20"))
...
def update_01():
    ...
    conn = conectar()
    cursor = conn.cursor()
    cursor.execute("UPDATE estudiantes SET email = ? WHERE id = ?", ("carlos.m@email.com", 2))
    conn.commit()
...
def update_02():
    ...
    conn = conectar()
    cursor = conn.cursor()
    cursor.execute("UPDATE cursos SET creditos = ? WHERE id = ?", (3, 4))
    conn.commit()
...
def update_03():
    ...
    conn = conectar()
    cursor = conn.cursor()
    cursor.execute("UPDATE inscripciones SET nota = ? WHERE estudiante_id = ? AND curso_id = ?", (14.5, 5, 2))
    conn.commit()
